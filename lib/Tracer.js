...
class Tracer extends EventEmitter {
  ...
  init() {
    ...
    if (this.settings && this.settings.logger && typeof this.setting.logger.info === "function" && typeof this.settings.logger.error === "function") {
    ...
    this.logger = (this.settings && typeof this.settings === "object" && this.setting.hasOwnProperty("logger")) ? this.settings.logger : mLogger;
